...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install apache2 libapache2-mod-php5 php5-sybase php5-gd php-pear php-apc php5-curl curl lynx-cur php5-memcached memcached wget
